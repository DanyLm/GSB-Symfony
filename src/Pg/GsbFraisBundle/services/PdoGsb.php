...
class PdoGsb {
    ...
    /**
     * Retourne la liste de tout les visiteurs
     * 
     */
    public function getLesVisiteurs(){
        ...
        $stmt = PdoGsb::$monPdo->prepare($req);
        $stmt->execute();
        $LesLigne = $stmt->fetchAll();
        return $LesLigne; 
    }
    
    /**
     * Retourne la liste de toute les fiche frais du visiteur
     * 
     */
    public function getFicheFraisVisiteur($visiteur_id){
        $req = "SELECT * FROM fichefrais f, etat e, visiteur v where f.idvisiteur=:visiteur_id and e.id = f.idetat and f.idvisiteur = v.id";
        $stmt = PdoGsb::$monPdo->prepare($req);
        $stmt->bindParam(':visiteur_id', $visiteur_id);
        $stmt->execute();
        $LesLigne = $stmt->fetchAll();
        return $LesLigne;
    }
    ...
    /**
     * Retourne la liste de tout les états
     * 
     */
    ...
    /**
     * Update la liste des fiches frais
     * 
     */
    public function setFicheFraisEtat($visiteur_id, $etat_id, $mois){
        $req = "UPDATE fichefrais set idetat=:etat_id, datemodif= DATE(NOW()) where idvisiteur=:visiteur_id and mois=:mois";
        $stmt = PdoGsb::$monPdo->prepare($req);
        $stmt->bindParam(':visiteur_id', $visiteur_id);
        $stmt->bindParam(':mois', $mois);
